---
title: "Hormony test on dataset scP"
...
```{r}
DimPlot(seurat_object, reduction = "umap",group.by = "Id")
...
```{r}
harmonized_seurat <- RunUMAP(seurat_object, reduction = "harmony", dims = 1:40)

```


```{r}
DimPlot(harmonized_seurat, reduction = "umap",group.by = "Id")
```
